...
">
    	<div class="container">
        	...
        	<div class="navbar-header">
        		...
        		<a class="navbar-brand" href="login_index.php">HappySnap</a>
        	</div>
...
<a href="login_kategori_header.php?id_kategori=2">
						Tessssssssssss
								</a>
							</li>
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu dropdown-with-icons">
							...
							<li>
								<a href="lokasi.php">
									<i class="material-icons">location_on</i>Lokasi								</a>
							</li>
					...
					<li>
						<a href="login_transaksi.php">
							<i class="material-icons">shopping_cart</i> Transaksi
						</a>
					</li>
					
                    <li>
						<a href="login.php"  class="btn btn-white btn-simple">
							<i class="material-icons">arrow_right_alt</i> LogOut
						</a>
